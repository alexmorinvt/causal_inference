...
# Methods included in the JSON summary block. The default set is just
# the MD + Random baselines. New methods under iteration should be
# added to this dict explicitly by the iteration that introduces them.
# Oracle is printed in the per-seed tables but excluded from the
# summary (it reads ground truth). Each entry is a zero-arg factory
